###########################################################################
## Makefile generated for Simulink model 'counter_SPI'. 
## 
## Makefile     : counter_SPI.mk
## Generated on : Tue Jun 26 12:57:52 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/counter_SPI.elf
...
MODELREF_LINK_RSPFILE_NAME = counter_SPI_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/counter_SPI.elf
...
DEFINES_STANDARD = -DMODEL=counter_SPI -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_SPI.c counter_SPI.c counter_SPI_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_SPI.c.o counter_SPI.c.o counter_SPI_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
